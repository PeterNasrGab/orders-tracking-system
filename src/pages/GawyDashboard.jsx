...
const Toast = ({ message, type = "info", onClose, duration = 5000 }) => {
  ...
  const getIcon = () => {
    switch (type) {
      ...
      case "info":
        return <FiInfo className="text-green-500 text-xl" />;
      default:
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter for Gawy orders only
        const barryOrders = orderList.filter(order => 
          order.orderType === "G" || order.orderId?.startsWith("G")
        );
        ...
        showToast("Gawy orders loaded successfully!", "success");
      } catch (error) {
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-gray-800 mb-2">Gawy Orders</h1>
              <p className="text-gray-600">Manage and track all Gawy orders</p>
            </div>
            <div className="w-32">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  <FiFilter className="text-2xl text-green-600" />
  ...
  <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-4">
    <div className="flex items-center justify-between">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h2 className="text-xl font-bold">Gawy Orders</h2>
  ...
  <div className="overflow-x-auto">
    <table className="w-full border-collapse text-sm" style={{ minWidth: isAdmin ? '2400px' : '1200px' }}>
      <thead>
        <tr className="bg-green-100 text-center">
          ...
          <th className="p-3 border-b font-semibold w-24 bg-green-200">Merged Pieces</th>
          ...
          <tr key={order.id} className="border-b hover:bg-gray-50 transition-colors">
            ...
            <td className="p-3">
              <select
                ...
                className="w-32 px-2 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm"
              >
              ...
              <div className="space-y-1">
                {(order.trackingNumbers?.length
                  ...
                  <input
                    ...
                    className="w-24 px-2 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm font-mono"
              ...
              <>
                ...
                <td className="p-3">
                  <input
                    ...
                    className="w-24 px-2 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm"
                  />
                </td>
                <td className="p-3">
                  <input
      ...
      {filteredOrders.length > 0 && (<tfoot>
        <tr className="bg-gray-50 border-t border-gray-200 font-bold">
          ...
          {/* Pieces total */}
          <td className="p-3 text-center text-green-700 font-mono bg-green-100">
            {totals.totalPieces}
          </td>
    ...
    {filteredOrders.length === 0 && (
      <div className="text-center py-12 text-gray-500">
        ...
        <p className="text-lg font-medium">No Gawy orders found</p>
