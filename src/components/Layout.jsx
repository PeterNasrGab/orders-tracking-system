...
export default function Layout() {
  ...
  const navLinks = [
    ...
    ...(isAdmin ? [
      ...
      { name: "System Settings", path: "/system-settings", icon: <FiSettings /> },
      ...
      >
        ...
        <div className="border-t bg-white p-2 shrink-0">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full p-3 mx-2 my-1 rounded-lg transition-colors hover:bg-red-100 text-gray-700 hover:text-red-700"
          >
